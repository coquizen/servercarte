...
func (r MenuRepository) ListSections(_ context.Context,) (*[]model.Section, error) {
...
func (r MenuRepository) FindSection(_ context.Context,section *model.Section) error {
...
func (r MenuRepository) CreateSection(_ context.Context,section *model.Section) error {
	if err := r.db.Where(
		"lower(title) = ?",
...
func (r MenuRepository) UpdateSection(_ context.Context,section *model.Section) error {
	return r.db.Save(section).Error
}

// UpdateSectionParent re-parents a subsection
func (r MenuRepository) UpdateSectionParent(_ context.Context, child *model.Section, newParent *model.Section) error {
	return r.db.Model(&newParent).Association("SubSections").Append(&child)
}

// DeleteSection deletes a section
func (r MenuRepository) DeleteSection(_ context.Context,section *model.Section) error {
	return r.db.Delete(section).Error
}

// ListItems lists all the users in the db
func (r MenuRepository) ListItems(_ context.Context,) (*[]model.Item, error) {
...
func (r MenuRepository) FindItem(_ context.Context, item *model.Item) error {
...
func (r MenuRepository) CreateItem(_ context.Context, item *model.Item) error {
...
func (r MenuRepository) UpdateItem(_ context.Context, item *model.Item) error {
	return r.db.Save(&item).Error
}


// UpdateItemParent re-parents an item
func (r MenuRepository) UpdateItemParent(_ context.Context, child *model.Item, newParent *model.Section) error {
	return r.db.Model(&newParent).Association("Items").Append(&child)
}

// DeleteItem deletes an item
func (r MenuRepository) DeleteItem(_ context.Context, item *model.Item) error {
	if err := r.db.Preload(clause.Associations).First(&item).Error; errors.Is(err, gorm.ErrRecordNotFound) {
		return err
	} else if err != nil {
		logger.Error.Printf("db connection error %v", err)
